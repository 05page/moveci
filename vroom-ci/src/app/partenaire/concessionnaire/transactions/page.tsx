...
/** Même contrat que GET /transactions-conclues/mes-transactions : tout l'historique du
 *  concessionnaire, tous statuts confondus. Même page que /vendeur/transactions, montée
 *  sous /partenaire/concessionnaire pour hériter du layout partenaire (sidebar). */
...
const PageMesTransactionsConcessionnaire = () => {
              ...
              <div className="mt-4 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                {enAttente.map((transaction) => (
                  <CarteTransaction
                    ...
                    perspective="vendeur"
                    hrefDetail={`/partenaire/concessionnaire/transactions/${transaction.id}`}
...
export default PageMesTransactionsConcessionnaire;
