...
/* Même page que /vendeur/clients/[id], montée sous /partenaire/concessionnaire pour hériter
   du layout partenaire (sidebar). */
...
const PageFicheClientConcessionnaire = ({ params }: ParametresPage) => {
  const { id } = use(params);
  return <FicheClient key={id} id={id} />;
};

export default PageFicheClientConcessionnaire;
  ...
  return (
    <main className="mx-auto w-full max-w-5xl flex-1 px-5 py-10">
      <div className="flex items-center justify-between gap-4">
        <Link
          href="/partenaire/concessionnaire/clients"
...
const FicheIntrouvable = () => (
  <main className="mx-auto w-full max-w-5xl flex-1 px-5 py-10">
    <section className="rounded-2xl border border-border p-12 text-center">
      ...
      <Link href="/partenaire/concessionnaire/clients" className={cn(buttonVariants({ size: "lg" }), "effet-action mt-8")}>
