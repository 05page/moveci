 ...
 *  Même page que /vendeur/vehicules, montée sous /partenaire/concessionnaire pour hériter
 *  du layout partenaire (sidebar) au lieu du layout vendeur. */
...
/** `?statut=` lié depuis les CarteStat du dashboard → valeur réelle de `StatutVehicule`. */
...
const PageMesVehiculesConcessionnaire = () => (
  <Suspense fallback={null}>
    <ListeMesVehicules />
  </Suspense>
);

export default PageMesVehiculesConcessionnaire;
...
const ListeMesVehicules = () => {
  ...
  // Init une seule fois depuis ?statut= (lien dashboard) — l'utilisateur reprend la main ensuite via les Select.
        ...
        <div className="mt-6 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {vehiculesAffiches.map((vehicule) => {
            ...
            return (
              ...
              >
                <Link href={`/partenaire/concessionnaire/vehicule/${vehicule.id}`} className="block">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    <DropdownMenuLinkItem
                      render={<Link href={`/partenaire/concessionnaire/vehicule/${vehicule.id}/modifier`} />}
                    >
