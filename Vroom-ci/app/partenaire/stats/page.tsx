    ...
    return (
        <FadeIn>
            <div className="space-y-6">
                ...
                {/* KPIs */}
                <StaggerList className={cn("grid gap-3 md:gap-4", isAutoEcole ? "grid-cols-2 lg:grid-cols-4" : "grid-cols-2 lg:grid-cols-5")}>
                    {statsCards.map((stat) => (
                ...
                {!isAutoEcole && <StatsChart data={data?.stats_mensuel ?? []} dataSemaine={data?.stats_semaine ?? []} />}
