...
const AuthContent = () => {
    ...
    const handleChangeLogin = (key: keyof FormLogin, value: string) => {
        setFormDataLogin(prev => ({ ...prev, [key]: value }))
        setLoginErrors(prev => ({ ...prev, [key]: "" }))
    }
    ...
    const handleRegisterSubmit = async (e: React.FormEvent) => {
        e.preventDefault()
        if (!formDataRegister.accepte_conditions) {
            setRegisterErrors(prev => ({ ...prev, accepte_conditions: "Vous devez accepter les conditions d'utilisation" }))
            return
        }
        setIsRegistering(true)
        try {
            const body: Record<string, string | number> = {
                fullname: isPartenaire ? formDataRegister.raison_sociale : formDataRegister.fullname,
                                        ...
                                        {registerStep === 2 && (
                                            <div className="space-y-5">
                                                <p className="text-sm font-semibold text-zinc-700">
                                                    {isPartenaire ? "Informations professionnelles" : "Informations personnelles"}
                                                </p>

                                                {/* Nom Complet — uniquement pour client et vendeur */}
                                                {!isPartenaire && (
                                                    <>
                                                        <div className="space-y-2">
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            {registerErrors.telephone && <p className="text-xs text-red-500">{registerErrors.telephone}</p>}
                                                        </div>
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            {registerErrors.adresse && <p className="text-xs text-red-500">{registerErrors.adresse}</p>}
                                                        </div>
                                                    </>
                                                )}
                                                        ...
                                                        <div className="space-y-2">
                                                            <div className="relative">
                                                                ...
                                                                <Input
                                                                    ...
                                                                    value={formDataRegister.telephone}
                                                                    onChange={(e) => handleChange("telephone", e.target.value)}
                                                                    placeholder="+225 07 00 01 02 03"
                                                                    className="pl-11 h-12 rounded-xl bg-white border-amber-200 focus:border-[#efbf04] focus:ring-[#efbf04]/20"
                                                                />
                                                            </div>
                                                        </div>
                                        ...
                                        {registerStep === 3 && (
                                            <div className="space-y-5">
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    {registerErrors.password_confirmation && <p className="text-xs text-red-500">{registerErrors.password_confirmation}</p>}
                                                </div>

                                                <div className="flex items-start gap-3">
                                                    <Checkbox
                                                        id="conditions"
                                                        checked={formDataRegister.accepte_conditions}
                                                        onCheckedChange={(checked) => handleChange("accepte_conditions", !!checked)}
                                                        className="mt-0.5"
                                                    />
                                                    <label htmlFor="conditions" className="text-xs text-zinc-400 leading-relaxed cursor-pointer">
                                                        J&apos;accepte les{" "}
                                                        <a href="#" className="text-move-gold hover:underline font-medium">conditions d&apos;utilisation</a>
                                                        {" "}et la{" "}
                                                        <a href="#" className="text-move-gold hover:underline font-medium">politique de confidentialité</a>.
                                                    </label>
                                                </div>
                                                {registerErrors.accepte_conditions && <p className="text-xs text-red-500">{registerErrors.accepte_conditions}</p>}
                                                ...
                                                <div className="flex gap-3">
                                                    ...
                                                    <Button
                                                        type="submit"
                                                        disabled={!formDataRegister.accepte_conditions}
                                                        className="flex-1 h-12 rounded-xl bg-[#efbf04] hover:bg-[#d4aa00] text-black font-bold text-sm cursor-pointer shadow-lg shadow-[#efbf04]/20"
                                                    >
                                                        {isRegistering
